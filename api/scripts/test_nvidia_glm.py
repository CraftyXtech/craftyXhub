#!/usr/bin/env python3
"""
Smoke-test an NVIDIA-routed chat model through the configured NIM route.
...
async def main() -> int:
    ...
    parser.add_argument(
        "--prompt",
        default="Reply with one sentence confirming the model is reachable through NVIDIA.",
    )
