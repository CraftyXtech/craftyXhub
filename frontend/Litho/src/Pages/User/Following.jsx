...
// API & Auth
import { useUserFollowing, useUserProfile } from '../../api/useUser'
...
const Following = (props) => {
    ...
    const { 
        ...
        hasMore 
    } = useUserFollowing(profileUser?.uuid, page, 20)
                        ...
                        <Col lg={10} xl={9}>
                            ...
                            {followingError ? (
                                <div className="text-center py-12">
                                    ...
                                    <h3 className="text-darkgray font-medium mb-2">Error Loading Following</h3>
                                    <p className="text-gray-600">{followingError}</p>
                                </div>
                            ) : following.length === 0 && !followingLoading ? (
                                <div className="text-center py-12">
                                    <i className="icon-user-following text-6xl text-gray-300 mb-4"></i>
                                    <h3 className="text-darkgray font-medium mb-2">Not Following Anyone</h3>
                                    ...
                                    {hasMore && (
                                        <div className="text-center pt-8">
                                            <Buttons
                                                ...
                                                color="#0038e3"
                                                size="md"
                                                title={followingLoading ? "Loading..." : "Load More"}
                                                icon={followingLoading ? "fas fa-spinner fa-spin" : "fas fa-chevron-down"}
                                                iconPosition="after"
                                            />
                                        </div>
                                    )}
