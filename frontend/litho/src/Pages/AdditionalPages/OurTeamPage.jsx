        ...
        <Container fluid className="text-center">
          <Row>
            <Col className="text-center mb-28 z-0 lg:mb-12 md:mb-20">
              <TiltBox>
                <div className="mb-[20px] block"><span className="font-serif font-medium text-white uppercase tracking-[1px] text-sm bg-darkgray inline-block px-[20px] py-[5px]">We are craftyxhub highly creative team</span></div>
