                          ...
                          item.dropdown.map((item, i) => {
                            return (
                              <li className="nav-item" key={i}>
                                {item.title && <Link className="nav-link" href={item.link ? item.link : "#"} > {item.icon && (<i className={`${item.icon} mr-[10px]`} ></i>)}{" "}
                                  {item.title}
                                </Link>}
                                {(item.img && item.link) && <Link href={item.link}><img height="235" alt="menu-banner" width="210" className="inline-block max-w-[210px]" src={item.img} /></Link>}
                              </li>
                            );
                          })}
                      </ul>
...
export const SearchBar = memo((props) => {
  ...
  return (
    <div className={`header-search-iconbar inline-block align-middle pl-[17px] text-[17px] leading-none${props.className ? ` ${props.className}` : ""}`} style={props.style}>
      <Link href="#" aria-label="search" className="search-form-icon leading-[20px]" onClick={(e) => e.preventDefault()}>
          ...
          isSearchModalOpen && (
            <Formik
              ...
              onSubmit={async (values, actions) => {
                ...
                actions.resetForm();
                setSearchModalOpen(false);
                Inertia.get("/page/search-result", { search: values.search });
              }}
            >
              <Form
                role="search"
...
export const HeaderLanguage = (props) => {
  return (
    <div className={`header-language dropdown inline-block align-middle pl-[17px] text-[17px]${props.className ? ` ${props.className}` : ""}`} style={props.style}>
      <Link href="#" aria-label="language" onClick={e => e.preventDefault()}>
      ...
      <ul className="dropdown-menu block absolute font-serif left-auto right-0 p-15px rounded-[6px] border-0 m-0 min-w-[140px]">
        <li>
          <Link aria-label="link" onClick={((e) => e.preventDefault())} href="#" title="English">
        ...
        <li>
          <Link aria-label="link" onClick={((e) => e.preventDefault())} href="#" title="England">
            <span className="icon-country block py-[2px] px-0 text-xs text-[#828282]">
              <img
        ...
        <li>
          <Link aria-label="link" onClick={((e) => e.preventDefault())} href="#" title="France">
            <span className="icon-country block py-[2px] px-0 text-xs text-[#828282]">
              <img
        ...
        <li>
          <Link aria-label="link" onClick={((e) => e.preventDefault())} href="#" title="Russian">
            <span className="icon-country block py-[2px] px-0 text-xs text-[#828282]">
              <img
        ...
        <li>
          <Link aria-label="link" onClick={((e) => e.preventDefault())} href="#" title="Spain">
            <span className="icon-country block py-[2px] px-0 text-xs text-[#828282]">
              <img
...
export const HeaderCart = (props) => {
  return (
    <div className={`header-cart-icon dropdown mr-[10px] inline-block align-middle pl-[17px] text-[17px]${props.className ? ` ${props.className}` : ""}`} style={props.style}>
      <Link aria-label="link" href="#" className="relative inline-block">
      ...
      <ul id="myTable" className="dropdown-menu block cart-item-list">
        <li className="cart-item items-center">
          <Link aria-label="link" href="#" className="font-serif close"> × </Link>
          ...
          <div className="product-detail font-serif">
            <Link aria-label="link" href="#">Delica omtantur</Link>
        ...
        <li className="cart-item items-center">
          ...
          <div className="product-detail font-serif">
            <Link aria-label="link" href="#">Gianvito rossi</Link>
